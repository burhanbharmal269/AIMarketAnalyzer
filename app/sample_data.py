...
def sample_market_snapshot():
    return {
        ...
        "eventCalendar": [
            {"name": "RBI Monetary Policy", "severity": "high", "minutesAway": 1620},
            {"name": "US CPI Release", "severity": "high", "minutesAway": 780},
        ],
        "news": [
...
def sample_candidates():
    return [
        ...
        },
        {
            ...
            "rr": 1.91,
            "eventRisk": False,
            "notes": ["Counter-trend puts are weak while index remains above key EMAs."],
        },
        {
            ...
            "rr": 2.75,
            "eventRisk": False,
            "notes": ["Underlying setup is acceptable, option market quality is not."],
        },
        {
            "id": "reliance-ce-3000",
            ...
            "rr": 3.12,
            "eventRisk": True,
            "notes": ["Stock options need stricter spread and event filters than index options."],
        },
    ]
